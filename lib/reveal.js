...
const Reveal = (() => {
  ...
  function build(img, opts, entry) {
    ...
    if (Array.isArray(entry)) {
      // whole-cartridge sweep: every pixel participates, and each entry's
      ...
      // cartridge front to back. Adjacent entries can share a boundary
